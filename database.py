    ...
    try:
        ...
        if cursor.fetchone()[0] == 0:
            ...
            initial_exercises = [
                ...
                {"name": "Side Plank", "body_group": "Core", "trx_flag": False},
                {"name": "Tricep Dips", "body_group": "Arms", "trx_flag": False},
                {"name": "Bicep Curls", "body_group": "Arms", "trx_flag": False},
                {"name": "Mountain Climbers", "body_group": "Full Body", "trx_flag": False},
                {"name": "Russian Twists", "body_group": "Core", "trx_flag": False},
                {"name": "V-Ups", "body_group": "Core", "trx_flag": False}
            ]
